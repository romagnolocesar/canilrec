        <?php
            ...
            function getHeaderContentWrapper(){
              echo "<div class='content-wrapper'><section class='content-header'><h1>Gerenciador<small>Gêneros</small></h1>";
              ?>
              <ol class="breadcrumb">
                <li><a href="<?php echo $GLOBALS['admin_base_url']; ?>"><i class="fa fa-dashboard"></i> Inicio</a></li>
                <li class="active">Genrenciador de Gêneros</li>
              </ol>
              <?php
              echo "</section>";
            }
        ...
        ?>
                ...
                <div class="box" id="genres-manager-grid hidden">
                    <div class="box-header">
                      <h3 class="box-title">Relação de Gêneros</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      ...
                      <?php
                        ...
                        $genresItens = json_decode($jsondata, TRUE);
                        echo "<table id='gridData' class='table table-bordered table-hover' url-api='".$GLOBALS['api']['genres']."/"."'>";
                        echo "  <thead>";
                        echo "    <tr>";
                                    echo "<td>Titulo</td>";
                                    echo "<td>Status</td>";
            ...
            <?php
                    ...
                    $json_string = $GLOBALS['api']['genres']."/".$_GET['id'];
                    $jsondata = file_get_contents($json_string);
                    $genresItem = json_decode($jsondata, TRUE);
                    getHeaderContentWrapper();
            ?>
                <section class="content container-fluid">  
                <div class="box box-warning" id="genres-manager-grid">
                    <div class="box-header">
                      <h3 class="box-title">Editar</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" id="dataform" method="post" enctype="multipart/form-data" action='<?php echo $GLOBALS["api"]["genres"]."/update/".$_GET['id']; ?>'>
                            <!-- text input -->
                            <div class="form-group">
                              <label>Titulo</label>
                              <input name="dataform[title]" type="text" class="form-control" placeholder="Enter ..." 
                                value="<?php echo utf8_decode($genresItem['title']); ?>">
                            </div>
                            <div class="form-group">
                                  <label>Descrição</label>
                                  <textarea id="wysieditor" name="dataform[text]" class="form-control" rows="3"><?php echo utf8_decode($genresItem['text']); ?></textarea> 
                            </div>                            
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input name="dataform[status]" type="checkbox" <?php if($genresItem['status']){echo 'checked';}?>>Ativo
                                </label>
                              </div>
                            </div>
                          </form>
            ...
            ?>
                ...
                <div class="box box-warning" id="genres-manager-grid">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form role="form" id="dataform" method="post" enctype="multipart/form-data" action='<?php echo $GLOBALS["api"]["genres"]."/new/"?>'>
                                <!-- text input -->
                                <div class="form-group">
                                  <label>Titulo</label>
