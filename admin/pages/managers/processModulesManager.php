        <?php
            ...
            function getHeaderContentWrapper(){
              echo "<div class='content-wrapper'><section class='content-header'><h1>Gerenciador<small>Modúlos de Processos</small></h1>";
              ?>
              <ol class="breadcrumb">
                <li><a href="<?php echo $GLOBALS['admin_base_url']; ?>"><i class="fa fa-dashboard"></i> Inicio</a></li>
                <li class="active">Genrenciador de Módulos de Processos</li>
              </ol>
              <?php
              echo "</section>";
            }
        ...
        ?>
                ...
                <div class="box" id="process-modules-manager-grid hidden">
                    <div class="box-header">
                      <h3 class="box-title">Relação de Módulos de Processos</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      ...
                      <?php
                        ...
                        echo "<table id='gridData' class='table table-bordered table-hover' url-api='".$GLOBALS['api']['processmodules']."/"."'>";
                        echo "  <thead>";
                        echo "    <tr>";
                                    echo "<td>Titulo</td>";
                        ...
                        echo "  <tbody>";
                                    foreach ($processModulesItens as $item) {
                                      echo "  <tr data-id='".$item['id']."'>";
                                        ...
                                        echo "  <td>".utf8_decode($item['subtitle'])."</td>";
                                        echo "  <td>";
                                            if($item['status'] == 1){
            ...
            <?php
                    ...
                    $json_string = $GLOBALS['api']['processmodules']."/".$_GET['id'];
                    $jsondata = file_get_contents($json_string);
                    $processModulesItem = json_decode($jsondata, TRUE);
                    getHeaderContentWrapper();
            ?>
                <section class="content container-fluid">  
                <div class="box box-warning" id="process-modules-manager-grid">
                    <div class="box-header">
                      <h3 class="box-title">Editar</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" id="dataform" method="post" enctype="multipart/form-data" action='<?php echo $GLOBALS["api"]["processmodules"]."/update/".$_GET['id']; ?>'>
                            <!-- text input -->
                            <div class="form-group">
                              <label>Titulo</label>
                              <input name="dataform[title]" type="text" class="form-control" placeholder="Enter ..." 
                                value="<?php echo utf8_decode($processModulesItem['title']); ?>">
                            </div>
                            <div class="form-group">
                              <label>Sub Titulo</label>
                              <input name="dataform[subtitle]" type="text" class="form-control" placeholder="Enter ..." 
                                value="<?php echo utf8_decode($processModulesItem['subtitle']); ?>">
                            </div>
                            <div class="form-group">
                              <label>Icone</label>
                              <input name="dataform[icon]" type="text" class="form-control" placeholder="Enter ..." 
                                value="<?php echo utf8_decode($processModulesItem['icon']); ?>">
                            </div>
                            <div class="form-group">
                              <label>Texto</label>
                              <textarea id="wysieditor" name="dataform[text]" class="form-control" rows="3" placeholder="Enter ..."><?php echo utf8_decode($processModulesItem['text']); ?></textarea> 
                            </div>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input name="dataform[status]" type="checkbox" <?php if($processModulesItem['status']){echo 'checked';}?>>Ativo
                                </label>
                              </div>
                            </div>
                          </form>
            ...
            ?>
                ...
                <div class="box box-warning" id="process-modules-manager-grid">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form role="form" id="dataform" method="post" enctype="multipart/form-data" action='<?php echo $GLOBALS["api"]["processmodules"]."/new/"?>'>
                                <!-- text input -->
                                <div class="form-group">
                                  <label>Titulo</label>
                                ...
                                <div class="form-group">
                                  <label>Sub Titulo</label>
                                  <input name="dataform[subtitle]" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                  <label>Icone</label>
