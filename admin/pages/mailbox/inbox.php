<?php
  $json_string = $GLOBALS['api']['mail']."/target/".$_SESSION['logged-user']->id;
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li onclick="" class="active"><a href="#"><i class="fa fa-inbox"></i> Recebidas
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    ?>
                        <tr  <?php if($value['viewed'] == 1){ echo "style='color:#999999'";} ?>>
                          <td><input type="checkbox"></td>
                          <td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-yellow"></i></a></td>
                    <?php
                          echo "<td onclick='readMail(".$value['id'].")' class='mailbox-name'>".utf8_decode($userItem['name'])." ".utf8_decode($userItem['lastname'])."</td>";
                          echo "<td onclick='readMail(".$value['id'].")'class='mailbox-subject'>".$value['subject']."</td>";                   
                    ?>
                          
                          <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
                    <?php
                          $date_variant = date("d-m-Y",intval($value['date']));
                          echo "<td onclick='readMail(".$value['id'].")'class='mailbox-date'>".$date_variant."</td>";
                    ?>
                        </tr>
                    <?php
                      }
